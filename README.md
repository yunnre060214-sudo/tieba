...
GitHub 会在公开仓库连续 60 天没有任何仓库活动时自动停用定时 Workflow。这个项目按你的选择不再制造“保活提交”；如果仓库长期没有提交，请进入 Actions 页面重新启用工作流。详见 [GitHub 官方说明](https://docs.github.com/en/actions/reference/workflows-and-actions/events-that-trigger-workflows#schedule)。
